...
const Roadmap2: React.FC<Roadmap2Props> = ({ items, RoadmapHeading }) => {
  return (
    <section className="overflow-x-hidden py-10">
      <h2 className="text-4xl font-bold text-center mb-15 px-4">{RoadmapHeading}</h2>

      <div className="relative max-w-6xl mx-auto">
        {/* Desktop line (center) */}
        <div className="absolute left-1/2 top-0 h-full w-1 bg-primary -translate-x-1/2 hidden sm:block" />
        {/* Mobile line (left) */}
        <div className="absolute left-8.5 top-0 h-full w-1 bg-primary sm:hidden" />
          ...
          {items.map((item, index) => {
            ...
            return (
              <div key={index} className="relative flex w-full">
                ...
                {/* Mobile layout (< md) */}
                <div className="flex sm:hidden w-full mx-3 relative">
