...
import HighlightCardWithIcon from "@/components/pvr/card/HighlightedCardwithIcon";
import TransparentCard from "@/components/pvr/card/TransparentCard";
import HighlightSection1 from "@/components/pvr/HighlightSection/HighlightSection1";
import MapSection from "@/components/pvr/map/MapSection";
import TypingText from "@/components/pvr/TypingText";
    ...
    <div className="mt-20 lg:mt-30">
      <div className="pt-10 bg-gradient-to-b from-primary via-primary/20 to-transparent mb-10">
        ...
        <div className="mt-20 px-[10%] ">
          <TransparentCard image="/images/home/slider/textile4.jpg" />
        </div>
      </div>
