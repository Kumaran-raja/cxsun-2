import HeroBanner from '@/components/pvr/banner/HeroBanner';
import Roadmap2 from '@/components/pvr/Roadmap/RoadMap2';
...
global customers.`,
    ...
    return (
        <div>
            <div className="relative mt-20 h-[40vh] w-full sm:h-[50vh] lg:mt-30">
                <img
            ...
            <section className="mx-auto max-w-5xl px-6 py-12">
                {/* Main Heading */}
                <h1 className="mb-10 text-center text-3xl font-bold text-gray-800 md:text-4xl">
                ...
                <div className="space-y-10">
                    {sections.map((section, idx) => (
                        <div key={idx}>
                            {/* Section Title */}
                            <h2 className="mb-6 border-b-2 border-primary/30 pb-2 text-xl font-semibold text-primary md:text-2xl">
                                {section.title}
                            </h2>
            ...
            <div className="mb-20 px-4 lg:px-[10%]">
                <HeroBanner
                    badgeText="🚀 Featured"
                    title="Manufacturing
Capabilities"
...
product development, manufacturing and distribution."
                    ...
                    buttonHandleClick={() => {
                        window.location.href = '/web-contacts';
                    }}
                />
            </div>
        </div>
